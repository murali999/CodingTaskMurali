...
@IBDesignable class ADVSegmentedControl: UIControl {
    ...
    @IBInspectable var unselectedLabelColor : UIColor = UIColor(red: 38/255, green: 123/255, blue: 185/255, alpha: 1) {
        didSet {
            setSelectedColors()
        }
    }
    
    @IBInspectable var thumbColor : UIColor = UIColor(red: 38/255, green: 123/255, blue: 185/255, alpha: 1) {
        didSet {
            setSelectedColors()
        }
    }
    
    @IBInspectable var borderColor : UIColor = UIColor(red: 38/255, green: 123/255, blue: 185/255, alpha: 1) {
        didSet {
    ...
    func setupLabels(){
        ...
        self.thumbView.frame = labels[0].frame;
        addIndividualItemConstraints(labels, mainView: self, padding: 0)
    }
